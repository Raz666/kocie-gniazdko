// Local preview for browser development; only serves the mockups directory.
...
}).listen(8765,'127.0.0.1',()=>console.log('Preview: http://127.0.0.1:8765/admin/kalendarz/mockup-kalendarz.html'));
